...
if __name__ == "__main__":
    ...
    total = input("Input total quantity: ")
    first_and_second_warehouse = input("Input quantity of first and second warehouse combined: ")
    second_and_third_warehouse = input("Input quantity of second and third warehouse combined:")
    print()

    result = calculate_warehouse_quantities(total, first_and_second_warehouse, second_and_third_warehouse)

    if result is not None:
        warehouse_one_data, warehouse_two_data, warehouse_three_data = result
